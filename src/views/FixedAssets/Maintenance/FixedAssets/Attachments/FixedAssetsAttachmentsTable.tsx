...
export default function FixedAssetsAttachmentsTable({ itemId }: ItemAttachmentProps) {
      ...
      >
        ...
        <Stack direction="row" spacing={1}>
          <Button
            variant="contained"
            color="primary"
            onClick={() => navigate("/itemsandinventory/maintenance/items/add-attachments")}
          >
            Add Attachment
          </Button>
                    ...
                    <TableCell align="center">
                      <Stack direction="row" spacing={1} justifyContent="center">
                        <Button
                          ...
                          startIcon={<EditIcon />}
                          onClick={() => navigate(
                            "/itemsandinventory/maintenance/items/update-attachments/"
                            // `/purchase/update-attachment/${att.id}`
                          )}
                        >
                          Edit
                        </Button>
