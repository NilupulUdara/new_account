...
export default function SupplierCreditNote() {
    ...
    const handleEnterCreditNote = () => alert("Credit Note Saved");
        ...
        <Stack spacing={2}>
            ...
            <Box mb={2}>
                ...
                <Stack direction="row" spacing={1} justifyContent="flex-end" mt={1} alignItems="center">
                    ...
                    <Button variant="contained" onClick={() => alert("Add All Item functionality not implemented")}>
                        Add All Item
                    </Button>
                </Stack>
            </Box>
