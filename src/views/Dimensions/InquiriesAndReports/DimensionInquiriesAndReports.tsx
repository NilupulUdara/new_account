...
function DimensionInquiriesAndReports() {
  ...
  const allItems = [
    ...
    {
      text: "DIMENSION REPORTS",
      change: +8,
      icon: <ReceiptLongIcon sx={{ fontSize: 40, color: "#1976d2" }} />,
      path: "/dimension/inquiriesandreports/dimension-reports"
    },
  ];
...
export default DimensionInquiriesAndReports;